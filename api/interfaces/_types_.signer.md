...
*Defined in [types.ts:171](https://github.com/polkadot-js/api/blob/5b92010/packages/api/src/types.ts#L171)*
...
*Defined in [types.ts:166](https://github.com/polkadot-js/api/blob/5b92010/packages/api/src/types.ts#L166)*
