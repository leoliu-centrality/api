...
*Defined in [types.ts:158](https://github.com/polkadot-js/api/blob/847d5d1/packages/api/src/types.ts#L158)*
...
*Defined in [types.ts:159](https://github.com/polkadot-js/api/blob/847d5d1/packages/api/src/types.ts#L159)*
...
*Defined in [types.ts:156](https://github.com/polkadot-js/api/blob/847d5d1/packages/api/src/types.ts#L156)*
