...
⊕ **new AvailabilityVote**(Types: *`TupleConstructors`*, value: *`any`*): [AvailabilityVote](_type_attestedcandidate_.availabilityvote.md)

*Inherited from [Tuple](_codec_tuple_.tuple.md).[constructor](_codec_tuple_.tuple.md#constructor)*

*Defined in [codec/Tuple.ts:22](https://github.com/polkadot-js/api/blob/1ed1bfa/packages/types/src/codec/Tuple.ts#L22)*
...
**Returns:** [AvailabilityVote](_type_attestedcandidate_.availabilityvote.md)
