...
*Defined in [primitive/StorageKey.ts:28](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L28)*

**Parameters:**

| Name | Type |
| ------ | ------ |
| value | [AnyU8a](../modules/_types_.md#anyu8a) \| [StorageKey](_primitive_storagekey_.storagekey.md) \| [StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md) \| [[StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md), `any`] |
...
*Defined in [primitive/Bytes.ts:61](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/Bytes.ts#L61)*
...
*Defined in [codec/U8a.ts:43](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L43)*
...
*Defined in [codec/U8a.ts:50](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L50)*
...
**get meta**(): [StorageFunctionMetadata](_metadata_v0_modules_.storagefunctionmetadata.md) \| `null`

*Defined in [primitive/StorageKey.ts:82](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L82)*
...
*Defined in [primitive/StorageKey.ts:89](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L89)*
...
*Defined in [codec/U8a.ts:58](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L58)*
...
*Defined in [codec/U8a.ts:73](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L73)*
...
*Defined in [codec/U8a.ts:80](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L80)*
...
*Defined in [codec/U8a.ts:87](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L87)*
...
*Defined in [codec/U8a.ts:94](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L94)*
...
*Defined in [primitive/Bytes.ts:69](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/Bytes.ts#L69)*
...
▸ **decodeStorageKey**(value: *[AnyU8a](../modules/_types_.md#anyu8a) \| [StorageKey](_primitive_storagekey_.storagekey.md) \| [StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md) \| [[StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md), `any`]*): `Uint8Array`

*Defined in [primitive/StorageKey.ts:37](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L37)*
...
▸ **getMeta**(value: *[StorageKey](_primitive_storagekey_.storagekey.md) \| [StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md) \| [[StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md), `any`]*): [StorageFunctionMetadata](_metadata_v0_modules_.storagefunctionmetadata.md) \| `null`

*Defined in [primitive/StorageKey.ts:51](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L51)*
...
▸ **getType**(value: *[StorageKey](_primitive_storagekey_.storagekey.md) \| [StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md) \| [[StorageFunction](../interfaces/_primitive_storagekey_.storagefunction.md), `any`]*): `string` \| `null`

*Defined in [primitive/StorageKey.ts:65](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/primitive/StorageKey.ts#L65)*
