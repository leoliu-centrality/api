...
*__description__*: The default contract code hash that is used accross the system. It is a wrapper around [Hash](_type_hash_.hash.md), representing a 32-byte blake2b (Substrate) value

# Hierarchy

↳  [Hash](_type_hash_.hash.md)
...
⊕ **new CodeHash**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [CodeHash](_type_codehash_.codehash.md)
