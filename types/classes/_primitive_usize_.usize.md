...
*__description__*: A System default unsigned number, typically used in RPC to report non-consensus data. It is a wrapper for [U64](_primitive_u64_.u64.md) as a 64-binary default
