...
*__description__*: A list of pending [Extrinsics](_type_extrinsics_.extrinsics.md)
...
⊕ **new PendingExtrinsics**(Type: *[Constructor](../interfaces/_types_.constructor.md)<`T`>*, value?: *[Vector](_codec_vector_.vector.md)<`any`> \| `Uint8Array` \| `string` \| `Array`<`any`>*): [PendingExtrinsics](_rpc_pendingextrinsics_.pendingextrinsics.md)
