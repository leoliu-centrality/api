...
*__name__*: ChangesTrieRoot

*__description__*: Log for changes to the Trie root
...
⊕ **new ChangesTrieRoot**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [ChangesTrieRoot](_type_digest_.changestrieroot.md)
