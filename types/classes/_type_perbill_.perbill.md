...
*__description__*: Parts per billion (see also [Permill](_type_permill_.permill.md))
...
⊕ **new Perbill**(value?: *[AnyNumber](../modules/_types_.md#anynumber)*): [Perbill](_type_perbill_.perbill.md)
...
**Returns:** [Perbill](_type_perbill_.perbill.md)
