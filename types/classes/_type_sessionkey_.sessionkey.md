...
*__description__*: Wrapper for a SessionKey. Same as an normal [AuthorityId](_type_authorityid_.authorityid.md), i.e. a wrapper around publicKey.

# Hierarchy

↳  [AuthorityId](_type_authorityid_.authorityid.md)
...
⊕ **new SessionKey**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [SessionKey](_type_sessionkey_.sessionkey.md)
