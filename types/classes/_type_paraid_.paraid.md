...
*__description__*: Identifier for a deployed parachain implemented as a [U32](_primitive_u32_.u32.md)
...
⊕ **new ParaId**(value?: *[AnyNumber](../modules/_types_.md#anynumber)*): [ParaId](_type_paraid_.paraid.md)
...
**Returns:** [ParaId](_type_paraid_.paraid.md)
