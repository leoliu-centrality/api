...
*__description__*: Log item that is just a stream of [Bytes](_primitive_bytes_.bytes.md)
...
⊕ **new Other**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [Other](_type_digest_.other.md)
...
*Defined in [primitive/Bytes.ts:18](https://github.com/polkadot-js/api/blob/eaea874/packages/types/src/primitive/Bytes.ts#L18)*
