...
⊕ **new BalanceUpload**(Types: *`TupleConstructors`*, value: *`any`*): [BalanceUpload](_type_attestedcandidate_.balanceupload.md)
...
**Returns:** [BalanceUpload](_type_attestedcandidate_.balanceupload.md)
