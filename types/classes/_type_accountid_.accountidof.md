...
*__description__*: The Substrate AccountIdOf representation as a [AccountId](_type_accountid_.accountid.md).

# Hierarchy

↳  [AccountId](_type_accountid_.accountid.md)
...
⊕ **new AccountIdOf**(value?: *[AnyU8a](../modules/_types_.md#anyu8a)*): [AccountIdOf](_type_accountid_.accountidof.md)

*Inherited from [AccountId](_type_accountid_.accountid.md).[constructor](_type_accountid_.accountid.md#constructor)*

*Overrides [U8aFixed](_codec_u8afixed_.u8afixed.md).[constructor](_codec_u8afixed_.u8afixed.md#constructor)*

*Defined in [type/AccountId.ts:19](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/type/AccountId.ts#L19)*
...
**Returns:** [AccountIdOf](_type_accountid_.accountidof.md)
...
*Defined in [codec/U8a.ts:36](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L36)*
...
*Defined in [codec/U8aFixed.ts:52](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8aFixed.ts#L52)*
...
*Inherited from [AccountId](_type_accountid_.accountid.md).[eq](_type_accountid_.accountid.md#eq)*

*Overrides [U8a](_codec_u8a_.u8a.md).[eq](_codec_u8a_.u8a.md#eq)*

*Defined in [type/AccountId.ts:46](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/type/AccountId.ts#L46)*
...
*Inherited from [AccountId](_type_accountid_.accountid.md).[toJSON](_type_accountid_.accountid.md#tojson)*

*Overrides [U8a](_codec_u8a_.u8a.md).[toJSON](_codec_u8a_.u8a.md#tojson)*

*Defined in [type/AccountId.ts:53](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/type/AccountId.ts#L53)*
...
*Inherited from [AccountId](_type_accountid_.accountid.md).[toString](_type_accountid_.accountid.md#tostring)*

*Overrides [U8a](_codec_u8a_.u8a.md).[toString](_codec_u8a_.u8a.md#tostring)*

*Defined in [type/AccountId.ts:60](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/type/AccountId.ts#L60)*
...
*Defined in [codec/U8a.ts:102](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/codec/U8a.ts#L102)*
...
*Inherited from [AccountId](_type_accountid_.accountid.md).[encode](_type_accountid_.accountid.md#encode)*

*Defined in [type/AccountId.ts:27](https://github.com/polkadot-js/api/blob/3057747/packages/types/src/type/AccountId.ts#L27)*
