...
*__name__*: Justification

*__description__*: A generic justification as a stream of [Bytes](_primitive_bytes_.bytes.md), this is specific per consensus implementation
